...
#import "CyKeyboardAvoidingScrollView.h"

#define _UIKeyboardFrameEndUserInfoKey (&UIKeyboardFrameEndUserInfoKey != NULL ? UIKeyboardFrameEndUserInfoKey : @"UIKeyboardBoundsUserInfoKey")

@interface CyKeyboardAvoidingScrollView ()
...
@implementation CyKeyboardAvoidingScrollView
{
...
@synthesize isTapAnyHideKeyboard = _isTapAnyHideKeyboard;

- (void)setup {
    _isTapAnyHideKeyboard = YES;
    _priorInsetSaved = NO;
...
- (void)keyboardWillShow:(NSNotification*)notification {
    ...
    [self setContentOffset:CGPointMake(self.contentOffset.x,
                                       [self idealOffsetForView:firstResponder withSpace:[self keyboardRect].origin.y - self.bounds.origin.y] - 64) animated:YES];
